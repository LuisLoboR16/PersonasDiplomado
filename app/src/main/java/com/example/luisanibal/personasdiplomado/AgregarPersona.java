...
public class AgregarPersona extends AppCompatActivity {
    ...
    public void guardar(View v){
        ...
        Persona p = new Persona(foto,ced,nomb,apel,sexo);
        p.guardar();

        Snackbar.make(v, getResources().getString(R.string.personaguardada),Snackbar.LENGTH_SHORT).setAction("Action",null).show();
        limpiar();
    }
